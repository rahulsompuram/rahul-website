            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <div className="main-container" style={{ paddingRight: 25, paddingLeft: 25 }}>
                <div className="about">
                  ...
                  <p style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}}>I'm Rahul, a product manager working on user growth at <span className="blue-text"><a id="underline" href="https://www.redfin.com/" target="_blank" rel="noopener noreferrer">Redfin</a></span>. I recently graduated from the <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">University of Pennsylvania</span> with a degree in computer science and economics.
                  ...
                  and <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">traveling</span> to new places (RIP ~covid-19~).</p>
