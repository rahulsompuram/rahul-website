            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <div className="main-container" style={{ paddingRight: 25, paddingLeft: 25 }}>
                <div className="about">
                  ...
                  In the past, I was a <span><a id="underline" href="https://fellows.kleinerperkins.com" target="_blank" rel="noopener noreferrer">Kleiner Perkins Engineering Fellow</a></span> at <span><a id="underline" href="https://www.betterworks.com" target="_blank" rel="noopener noreferrer">BetterWorks</a></span>.
