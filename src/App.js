            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <div className="main-container" style={{ paddingRight: 25, paddingLeft: 25 }}>
                <div className="about">
                  ...
                  <p style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}}>I'm Rahul, a product manager working on making data more accessible and trustworthy at <span className="blue-text"><a id="underline" href="https://transform.co/" target="_blank" rel="noopener noreferrer">Transform</a></span>.<br/><br/> Before that, I was a product manager at <span className="blue-text"><a id="underline" href="https://www.redfin.com/" target="_blank" rel="noopener noreferrer">Redfin</a></span>, where I worked on data platform and user growth initiatives. I studied CS & Econ at the University of Pennsylvania.
                  During school, I was a <span><a id="underline" href="https://fellows.kleinerperkins.com/meet-the-fellows/2019" target="_blank" rel="noopener noreferrer">Kleiner Perkins Engineering Fellow</a></span> at <span><a id="underline" href="https://www.betterworks.com" target="_blank" rel="noopener noreferrer">BetterWorks</a></span>.
                  I also started <span className="blue-text"><a id="underline" href="https://www.34st.com/article/2019/02/ego-rahul-sompuram-buzzhealth" target="_blank" rel="noopener noreferrer">Raft Health (formerly Buzz Health)</a></span>, a mobile resource app for patients with serious or chronic conditions and their supporters. We were grantees of
                  the 1517 Fund, finalists for Y-Combinator's W'19 batch, and worked with some of the top U.S. pediatric hospitals. </p>
                  ...
                  and <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">traveling</span> to new places.</p>
