      ...
      <div className="App" style={{backgroundColor: this.state.isClicked ? "#243447" : "#FFFFFF"}}>
        ...
        <div className="main-container">
          <div className="about">
            ...
            <p style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}}>I'm Rahul, a rising senior at the <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">University of Pennsylvania</span> studying computer science and economics.
            ...
            <p style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}}>My career interests lie in <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">product management</span>, <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">software engineering</span>, and <span style={{color: this.state.isClicked ? "#FFFFFF" : "#585858"}} className="gray-text">data science</span>. I love connecting with fellow explorers, creators, and dreamers so please don't hesitate to reach out!</p>
